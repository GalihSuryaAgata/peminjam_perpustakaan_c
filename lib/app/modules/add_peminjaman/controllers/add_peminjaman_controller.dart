...
import 'package:peminjam_perpustakaan_klasc/app/data/provider/storage_provider.dart';
    ...
    try {
      ...
      if (e.response != null) {
        if (e.response?.data != null) {
          Get.snackbar('Sorry Sorry', '${e.response?.data['message']}',
              backgroundColor: Colors.orange);
        }
      } else {
        Get.snackbar('Sorry okeay', e.message ?? '', backgroundColor: Colors.red);
      }
    } catch (e) {
      loading(false);
